...
public class Employee extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        e_mobile = new javax.swing.JTextField();
        e_cp = new javax.swing.JTextField();
        ...
        e_address.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        e_address.setText("0");
        ...
        e_email.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        e_email.setText("0");

        e_mobile.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        e_mobile.setText("0");

        e_cp.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        e_cp.setText("0");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(56, 56, 56)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(e_tp, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(e_mobile, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(e_cp, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(e_email, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(e_address, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(e_name, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(39, 39, 39)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(e_cp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(e_mobile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Supplier_ Name", "T.P Number", "Address", "Email", "Contact_Person", "Mobile"
            }
        ));
        ...
        e_search.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        e_search.setText("0");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(e_search, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void updateTable() {
        String[] columnNames = {"No", "Employee Name", "T.P Number", "Address", "Email", "Contact Person", "Mobile"};
        ...
        try {
            ...
            System.out.println("Error Occured while fetching employee data..." + e);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String contact_person = e_cp.getText();
        String mobile = e_mobile.getText();
        
        try {
            String sql = "INSERT INTO dbo.employee (name, Tp_Number,address,email,contact_person,mobile) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            String sql = "SELECT * FROM dbo.employee WHERE e_id = ?";
            PreparedStatement s = DBUtil.getConnection().prepareStatement(sql);
            ...
            while (resultSet.next()) {
                ...
                e_tp.setText (tpNumber);
                e_email.setText (email);
                e_cp.setText (contactPerson);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (id == null || id.trim().isEmpty()) {
            System.out.println("Employee ID cannot be empty. Deletion aborted.");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id == null || id.trim().isEmpty()) {
            System.out.println("Employee ID cannot be empty. Update aborted.");
            return; 
        }

        try {
            
            String sql = "UPDATE dbo.employee SET name = ?, Tp_Number = ?, address = ?, email = ?, contact_person = ?, mobile = ? WHERE e_id = ?";
    ...
    private javax.swing.JTextField e_cp;
    private javax.swing.JTextField e_email;
    private javax.swing.JTextField e_mobile;
